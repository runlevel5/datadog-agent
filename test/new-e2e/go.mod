...
require (
	...
	github.com/DataDog/datadog-agent/pkg/util/testutil v0.52.0-rc.4
	github.com/DataDog/datadog-agent/pkg/version v0.52.0-rc.4
	github.com/DataDog/datadog-agent/test/fakeintake v0.52.0-rc.4
	...
	github.com/DataDog/test-infra-definitions v0.0.0-20240221174424-180d0c3c5d44
