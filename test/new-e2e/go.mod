...
require (
	...
	github.com/DataDog/datadog-agent/test/fakeintake v0.54.0-rc.1
	...
	github.com/DataDog/test-infra-definitions v0.0.0-20240429073238-98a37ef8c8a9
...
require (
	github.com/DataDog/datadog-agent/comp/netflow/payload v0.54.0-rc.1 // indirect
