...
require (
	...
	github.com/DataDog/datadog-agent/comp/core/log v0.51.1
	github.com/DataDog/datadog-agent/comp/core/secrets v0.51.1
	github.com/DataDog/datadog-agent/comp/core/telemetry v0.51.1
	github.com/DataDog/datadog-agent/comp/logs/agent/config v0.51.1
	github.com/DataDog/datadog-agent/pkg/aggregator/ckey v0.51.1
	github.com/DataDog/datadog-agent/pkg/collector/check/defaults v0.51.1
	github.com/DataDog/datadog-agent/pkg/config/env v0.51.1
	github.com/DataDog/datadog-agent/pkg/config/logs v0.51.1
	github.com/DataDog/datadog-agent/pkg/config/model v0.51.1
	github.com/DataDog/datadog-agent/pkg/config/remote v0.51.1
	github.com/DataDog/datadog-agent/pkg/config/setup v0.51.1
	github.com/DataDog/datadog-agent/pkg/config/utils v0.51.1
	github.com/DataDog/datadog-agent/pkg/errors v0.51.1
	github.com/DataDog/datadog-agent/pkg/metrics v0.51.1
	github.com/DataDog/datadog-agent/pkg/networkdevice/profile v0.51.1
	github.com/DataDog/datadog-agent/pkg/orchestrator/model v0.51.1
	github.com/DataDog/datadog-agent/pkg/process/util/api v0.51.1
	github.com/DataDog/datadog-agent/pkg/proto v0.51.1
	github.com/DataDog/datadog-agent/pkg/status/health v0.51.1
	github.com/DataDog/datadog-agent/pkg/tagset v0.51.1
	github.com/DataDog/datadog-agent/pkg/telemetry v0.51.1
	github.com/DataDog/datadog-agent/pkg/util/backoff v0.51.1
	github.com/DataDog/datadog-agent/pkg/util/cache v0.51.1
	github.com/DataDog/datadog-agent/pkg/util/common v0.51.1
	github.com/DataDog/datadog-agent/pkg/util/compression v0.51.1
	github.com/DataDog/datadog-agent/pkg/util/executable v0.51.1
	github.com/DataDog/datadog-agent/pkg/util/filesystem v0.51.1
	github.com/DataDog/datadog-agent/pkg/util/fxutil v0.51.1
	github.com/DataDog/datadog-agent/pkg/util/grpc v0.51.1
	github.com/DataDog/datadog-agent/pkg/util/hostname/validate v0.51.1
	github.com/DataDog/datadog-agent/pkg/util/http v0.51.1
	github.com/DataDog/datadog-agent/pkg/util/json v0.51.1
	github.com/DataDog/datadog-agent/pkg/util/optional v0.51.1
	github.com/DataDog/datadog-agent/pkg/util/sort v0.51.1
	github.com/DataDog/datadog-agent/pkg/util/statstracker v0.51.1
