...
require (
	...
	github.com/DataDog/datadog-agent/pkg/gohai v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/obfuscate v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/remoteconfig/state v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/security/secl v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/trace v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/util/cgroups v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/util/log v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/util/pointer v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/util/scrubber v0.52.0-rc.2
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/ebs v1.23.0 // indirect
...
require (
	...
	github.com/DataDog/datadog-agent/cmd/agent/common/path v0.52.0-rc.2
	github.com/DataDog/datadog-agent/comp/core/config v0.52.0-rc.2
	github.com/DataDog/datadog-agent/comp/core/flare/types v0.52.0-rc.2
	github.com/DataDog/datadog-agent/comp/core/hostname/hostnameinterface v0.52.0-rc.2
	github.com/DataDog/datadog-agent/comp/core/log v0.52.0-rc.2
	github.com/DataDog/datadog-agent/comp/core/secrets v0.52.0-rc.2
	github.com/DataDog/datadog-agent/comp/core/status v0.52.0-rc.2
	github.com/DataDog/datadog-agent/comp/core/status/statusimpl v0.52.0-rc.2
	github.com/DataDog/datadog-agent/comp/core/telemetry v0.52.0-rc.2
	github.com/DataDog/datadog-agent/comp/forwarder/defaultforwarder v0.52.0-rc.2
	github.com/DataDog/datadog-agent/comp/forwarder/orchestrator/orchestratorinterface v0.52.0-rc.2
	github.com/DataDog/datadog-agent/comp/logs/agent/config v0.52.0-rc.2
	github.com/DataDog/datadog-agent/comp/otelcol/otlp/components/exporter/serializerexporter v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/aggregator/ckey v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/api v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/collector/check/defaults v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/config/env v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/config/logs v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/config/model v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/config/remote v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/config/setup v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/config/utils v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/errors v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/metrics v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/networkdevice/profile v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/orchestrator/model v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/process/util/api v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/proto v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/serializer v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/status/health v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/tagset v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/telemetry v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/util/backoff v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/util/cache v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/util/common v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/util/compression v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/util/executable v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/util/filesystem v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/util/flavor v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/util/fxutil v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/util/grpc v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/util/hostname/validate v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/util/http v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/util/json v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/util/optional v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/util/sort v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/util/statstracker v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/util/system v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/util/testutil v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/util/uuid v0.52.0-rc.2
	github.com/DataDog/datadog-agent/pkg/util/winutil v0.52.0-rc.2
	...
	github.com/aws/aws-sdk-go-v2/service/kms v1.29.0
...
require (
	...
	github.com/DataDog/datadog-agent/pkg/util/buf v0.52.0-rc.2 // indirect
	github.com/DataDog/datadog-agent/pkg/util/system/socket v0.52.0-rc.2 // indirect
	...
	github.com/aws/aws-sdk-go-v2/service/accessanalyzer v1.28.0 // indirect
	github.com/aws/aws-sdk-go-v2/service/apigateway v1.23.0 // indirect
	github.com/aws/aws-sdk-go-v2/service/apigatewayv2 v1.20.0 // indirect
	github.com/aws/aws-sdk-go-v2/service/appconfig v1.28.0 // indirect
	github.com/aws/aws-sdk-go-v2/service/athena v1.40.0 // indirect
	...
	github.com/aws/aws-sdk-go-v2/service/cloudwatch v1.36.0 // indirect
	github.com/aws/aws-sdk-go-v2/service/cloudwatchlogs v1.34.0 // indirect
	github.com/aws/aws-sdk-go-v2/service/codebuild v1.30.0 // indirect
	github.com/aws/aws-sdk-go-v2/service/docdb v1.33.0 // indirect
	github.com/aws/aws-sdk-go-v2/service/dynamodb v1.30.0 // indirect
	github.com/aws/aws-sdk-go-v2/service/ecr v1.27.0 // indirect
	github.com/aws/aws-sdk-go-v2/service/ecs v1.41.0 // indirect
	github.com/aws/aws-sdk-go-v2/service/efs v1.28.0 // indirect
	github.com/aws/aws-sdk-go-v2/service/eks v1.40.0 // indirect
	github.com/aws/aws-sdk-go-v2/service/elasticache v1.37.0 // indirect
	github.com/aws/aws-sdk-go-v2/service/elasticloadbalancingv2 v1.30.0 // indirect
	github.com/aws/aws-sdk-go-v2/service/elasticsearchservice v1.28.0 // indirect
	github.com/aws/aws-sdk-go-v2/service/emr v1.39.0 // indirect
	github.com/aws/aws-sdk-go-v2/service/eventbridge v1.30.0 // indirect
	github.com/aws/aws-sdk-go-v2/service/iam v1.31.0 // indirect
	...
	github.com/aws/aws-sdk-go-v2/service/kafka v1.30.0 // indirect
	github.com/aws/aws-sdk-go-v2/service/kinesis v1.27.0 // indirect
	github.com/aws/aws-sdk-go-v2/service/lambda v1.53.0 // indirect
	github.com/aws/aws-sdk-go-v2/service/mq v1.22.0 // indirect
	github.com/aws/aws-sdk-go-v2/service/neptune v1.31.0 // indirect
	github.com/aws/aws-sdk-go-v2/service/redshift v1.43.0 // indirect
	github.com/aws/aws-sdk-go-v2/service/s3 v1.51.0 // indirect
	github.com/aws/aws-sdk-go-v2/service/sfn v1.26.0 // indirect
	github.com/aws/aws-sdk-go-v2/service/sns v1.29.0 // indirect
	github.com/aws/aws-sdk-go-v2/service/sqs v1.31.0 // indirect
	github.com/aws/aws-sdk-go-v2/service/workspaces v1.38.0 // indirect
