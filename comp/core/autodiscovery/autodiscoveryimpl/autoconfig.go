...
func newAutoConfig(deps dependencies) autodiscovery.Component {
	ac := createNewAutoConfig(scheduler.NewSchedulerController(), deps.Secrets, deps.WMeta)
...
func createNewAutoConfig(schedulerController *scheduler.SchedulerController, secretResolver secrets.Component, wmeta optional.Option[workloadmeta.Component]) *AutoConfig {
...
func newOptionalAutoConfig(deps optionalModuleDeps) optional.Option[autodiscovery.Component] {
	...
	return optional.NewOption[autodiscovery.Component](
		createNewAutoConfig(scheduler.NewSchedulerController(), deps.Secrets, deps.WMeta))
}
