...
func newAutoConfig(deps dependencies) autodiscovery.Component {
	ac := createNewAutoConfig(scheduler.NewController(), deps.Secrets, deps.WMeta)
...
func createNewAutoConfig(schedulerController *scheduler.Controller, secretResolver secrets.Component, wmeta optional.Option[workloadmeta.Component]) *AutoConfig {
...
func newOptionalAutoConfig(deps optionalModuleDeps) optional.Option[autodiscovery.Component] {
	...
	return optional.NewOption[autodiscovery.Component](
		createNewAutoConfig(scheduler.NewController(), deps.Secrets, deps.WMeta))
}
