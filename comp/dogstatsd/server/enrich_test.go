...
func TestEnrichTags(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			args: args{
				tags:          []string{"env:prod", fmt.Sprintf("%s%s", entityIDTagPrefix, "42"), CardinalityTagPrefix + collectorstypes.HighCardinalityString},
				originFromUDS: "originID",
				conf: enrichConfig{
					defaultHostname:           "foo",
					entityIDPrecedenceEnabled: false,
		...
		},
		{
			...
			args: args{
				tags:          []string{"env:prod", fmt.Sprintf("%s%s", entityIDTagPrefix, "42"), CardinalityTagPrefix + collectorstypes.OrchestratorCardinalityString},
				originFromUDS: "originID",
				conf: enrichConfig{
					defaultHostname:           "foo",
					entityIDPrecedenceEnabled: false,
		...
		},
		{
			...
			args: args{
				tags:          []string{"env:prod", fmt.Sprintf("%s%s", entityIDTagPrefix, "42"), CardinalityTagPrefix + collectorstypes.LowCardinalityString},
				originFromUDS: "originID",
				conf: enrichConfig{
					defaultHostname:           "foo",
					entityIDPrecedenceEnabled: false,
		...
		},
		{
			...
			args: args{
				tags:          []string{"env:prod", fmt.Sprintf("%s%s", entityIDTagPrefix, "42"), CardinalityTagPrefix + collectorstypes.UnknownCardinalityString},
				originFromUDS: "originID",
				conf: enrichConfig{
					defaultHostname:           "foo",
					entityIDPrecedenceEnabled: false,
