...
static __always_inline bool read_hpack_int_with_given_current_char(struct __sk_buff *skb, skb_info_t *skb_info, __u16 current_char_as_number, __u16 max_number_for_bits, __u16 *out) {
...
// otherwise.
static __always_inline bool read_hpack_int(struct __sk_buff *skb, skb_info_t *skb_info, __u16 max_number_for_bits, __u16 *out) {
    __u16 current_char_as_number = 0;
...
static __always_inline bool parse_field_literal(struct __sk_buff *skb, skb_info_t *skb_info, http2_header_t *headers_to_process, __u16 index, __u64 global_dynamic_counter, __u8 *interesting_headers_counter, http2_telemetry_t *http2_tel) {
    __u16 str_len = 0;
