...
static __always_inline void cleanup_conn(void *ctx, conn_tuple_t *tup, struct sock *sk, void (*flush_conn)(conn_t *conn, void *ctx)) {
...
static __always_inline void handle_tcp_close(struct pt_regs *ctx, void (*flush_conn)(conn_t *conn, void *ctx)) {
    struct sock *sk;
    conn_tuple_t t = {};
    ...
    cleanup_conn(ctx, &t, sk, flush_conn);
