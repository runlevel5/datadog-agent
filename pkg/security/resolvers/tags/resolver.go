...
func (n *nullTagger) Tag(_ string, _ collectorstypes.TagCardinality) ([]string, error) {
	return nil, nil
}
...
func (t *DefaultResolver) Resolve(id string) []string {
	tags, _ := t.tagger.Tag("container_id://"+id, collectorstypes.OrchestratorCardinality)
	return tags
}

// ResolveWithErr returns the tags for the given id
func (t *DefaultResolver) ResolveWithErr(id string) ([]string, error) {
	return t.tagger.Tag("container_id://"+id, collectorstypes.OrchestratorCardinality)
}
