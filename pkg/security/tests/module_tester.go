...
func setTestPolicy(dir string, syntheticProbes []rules.SyntheticHookPoint, macros []*rules.MacroDefinition, rules []*rules.RuleDefinition) (string, error) {
	...
	if err := tmpl.Execute(buffer, map[string]interface{}{
		"SyntheticProbes": syntheticProbes,
		"Rules":           rules,
		"Macros":          macros,
	}); err != nil {
		return "", fail(err)
