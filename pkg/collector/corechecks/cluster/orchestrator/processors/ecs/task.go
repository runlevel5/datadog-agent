...
func (t *TaskHandlers) ExtractResource(_ processors.ProcessorContext, resource interface{}) (resourceModel interface{}) {
...
func (t *TaskHandlers) ResourceList(_ processors.ProcessorContext, list interface{}) (resources []interface{}) {
...
func (t *TaskHandlers) ResourceUID(_ processors.ProcessorContext, resource interface{}) types.UID {
...
func (t *TaskHandlers) ResourceVersion(_ processors.ProcessorContext, _ interface{}, resourceModel interface{}) string {
	resourceJSON, err := json.Marshal(resourceModel)
	if err != nil {
	...
	h := fnv.New64a()
	_, err = h.Write(resourceJSON)
	if err != nil {
		log.Warnc(fmt.Sprintf("Fail to compute ECS task resource version: %s", err.Error()), orchestrator.ExtraLogContext...)
		return ""
	}

	resourceModel.(*model.ECSTask).TaskVersion = strconv.FormatUint(h.Sum64(), 10)
	return resourceModel.(*model.ECSTask).TaskVersion
}
